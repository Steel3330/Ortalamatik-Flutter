...
import 'package:flutter_application_2/modal/ders.dart';
        ...
        children: [
                      ...
                      decoration: InputDecoration(
                        border: OutlineInputBorder(
                          ...
                          borderSide: const BorderSide(
                              width: 3, color: Color.fromARGB(255, 8, 17, 21)),
                        ),
                      ),
                      value: dropdownvalue,
          ...
          Container(
            decoration: const BoxDecoration(
              border: Border(
                bottom: BorderSide(
                    width: 2, color: Color.fromARGB(255, 41, 172, 184)),
              ),
            ),
            height: 1,
                ...
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                      ...
                      style: const TextStyle(
                          fontSize: 34,
                          color: Color.fromARGB(255, 110, 35, 29)),
                    ),
                  ],
                ),
              ),
          ...
          Container(
            decoration: const BoxDecoration(
              border: Border(
                bottom: BorderSide(
                    width: 2, color: Color.fromARGB(255, 11, 33, 45)),
              ),
            ),
            height: 1,
            width: double.infinity,
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return Container(
                    decoration: BoxDecoration(
                      border: Border.all(
                        color: Color.fromARGB(255, 2, 2, 11),
                        width: 1.0,
                      ),
                      borderRadius: BorderRadius.circular(8.0),
                    ),
                    child: ListTile(
                      tileColor: Color.fromARGB(255, 33, 59, 94),
                      title: InkWell(
                        onLongPress: () {
                          setState(() {
                            lessons.remove(item);
